...
def zamenjaj_elementa(sez, i, j):
    ...
    if i == j:
        return sez
    if i  not in range(len(sez)) or j not in range(len(sez)):
        return sez
    nov_sez = sez[:i]+[sez[j]]+sez[i+1:j]+[sez[i]]+sez[j+1:]

    return nov_sez

    # if i in range(len(sez)) or j in range(len(sez)):
    #     nov = sez[:]
    #     nov[i], nov[j] = nov[j], nov[i]
    #     return nov
    # else:
    #     return sez
# =====================================================================@009771=
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzY5LCJ1c2VyIjoxMTUzOH0:1w4i0X:YYHF6EDrfCpB4LzNGrr2xOj_jpkZdmjSB-4cJvQjUmg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzcwLCJ1c2VyIjoxMTUzOH0:1w4i0X:ye2zobl5Eb646gmEx962OQPYy0J9kf7Ajc0yy2I7Wxg"
        try:
            ...
            Check.equal('zamenjaj_elementa([1, 2, 3, 4, 5], 0, 1)', [2, 1, 3, 4, 5])
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzcxLCJ1c2VyIjoxMTUzOH0:1w4i0X:nQch8DIADJPDgnuO5PLF5RBLtLh_x8G8GZCw6lEMVl0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODEyLCJ1c2VyIjoxMTUzOH0:1w4i0X:TTI1xmcw0naUWOAFw85thbi0FP8x1O_EzPQLq9590GA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDExNiwidXNlciI6MTE1Mzh9:1w4i0X:-xHQVrXHHKLptqYZZytQdaHZjlDwlGjT5WoS3KaEIE0"
        try:
