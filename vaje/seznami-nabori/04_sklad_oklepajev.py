...
def naivna_resitev(niz):
    navadni_ok = niz.count("(") == niz.count(")")
    oglati_ok = niz.count("[") == niz.count("]")
    zaviti_ok = niz.count("{") == niz.count("}")
    return navadni_ok and oglati_ok and zaviti_ok
# =====================================================================@013394=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDI2OSwidXNlciI6MTE1Mzh9:1w4i0X:kjCL-ghBnhXx9d1JlD55rnKTkNJ05oZulaN38lYAl6Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzM5NCwidXNlciI6MTE1Mzh9:1w4i0X:Wr4e4BFDTpdSHUt3PmKeoN0DHi5iX5OGp89esRfg1fY"
        try:
