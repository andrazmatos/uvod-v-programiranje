...
#     True
# =============================================================================
def prvi_najvecji(niz):
    if len(niz) == 0:  ### if not seznam:
        return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEyOCwidXNlciI6MTE1Mzh9:1w4i0X:cVycer_xRyyRfiwkxglCd0zpP2r1QUu_FtV52zqRkjg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEyOSwidXNlciI6MTE1Mzh9:1w4i0X:smddXOBmovVlSjA5fzAqmtQRcrQNY_4zWjsxQjMOyrc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEzMiwidXNlciI6MTE1Mzh9:1w4i0X:kq8tPPhSBI6asstlKiId_lrlWZOQf0P_vTUNzYgKYMs"
        try:
