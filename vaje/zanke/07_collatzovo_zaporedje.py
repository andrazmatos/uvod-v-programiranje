...
# =============================================================================
def dolzina_zaporedja(clen):
    i = 1
    while clen != 1:
        clen = naslednji_clen(clen)
        i +=1
    return i
# =====================================================================@000987=
# 3. podnaloga
...
# =============================================================================
def najvecji_clen(clen):
    i = clen
    while clen != 1:
        if naslednji_clen(clen) > i:
            i = naslednji_clen(clen)
        clen = naslednji_clen(clen)
    return i
# =====================================================================@000988=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODUsInVzZXIiOjExNTM4fQ:1w3DEL:pzA5W0fOT8syK9npv2oIfU-EpOpMkN2cMOjkMeMG7CA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODYsInVzZXIiOjExNTM4fQ:1w3DEL:bT5HqghZhicMJuQcUJH3Ya3dRsV2TjBhdp5v-G95l0Q"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODcsInVzZXIiOjExNTM4fQ:1w3DEL:BuqE85foMhXBn1vokjZGgxAWcdG0BTOEYlPQkFY0sT4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODgsInVzZXIiOjExNTM4fQ:1w3DEL:emaMNKYtyaar1kkTMkdVTVFPBEC66ayHZluCwce6GJ8"
        try:
