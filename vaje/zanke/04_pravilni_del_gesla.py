...
# =============================================================================
def pravilni_del_gesla(geslo, niz):
    novo_geslo = ''
    for znak in geslo:
        if znak in niz:
            novo_geslo += znak
...
def nepravilni_ugibi(geslo, nniz):
    nov_niz = ''
    for i in nniz:
        if i not in geslo:
            nov_niz += i
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NSwidXNlciI6MTE1Mzh9:1w3DEL:i9lC7XKf_TiQaab-W0O7uQzGR3HvBMHYjGcOI0HtcKs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NiwidXNlciI6MTE1Mzh9:1w3DEL:7naCRmpERyrHNtl8il0fE_j_r9VDUoulrJ6ErjC6vxw"
        try:
