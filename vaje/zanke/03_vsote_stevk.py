...
# =============================================================================
def vsota_stevk_stevil_med(k, n):
    m = 0
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODEsInVzZXIiOjExNTM4fQ:1w3DEL:kfwv2vzRuJZnEjs6S8lY0WvN8POqZifon55glmQ-MO8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODIsInVzZXIiOjExNTM4fQ:1w3DEL:OTfq-vfv-npIB0v4Mm3hUPIEK4ThF0f9kLaFugQYPpA"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODMsInVzZXIiOjExNTM4fQ:1w3DEL:i9OdAASkhdaNbj4xSIYeqjCv9Lc5-db_aU3iZ_kxj4M"
        try:
