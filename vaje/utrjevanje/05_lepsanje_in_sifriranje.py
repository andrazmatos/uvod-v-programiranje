...
def cik_cak(niz):
    ...
    for i in niz:
        ...
        if i not in 'asdfghjklqwertzuiopyxcvbnmASDFGHJKLYXCVBNMQWERTZUIOP':
            continue
        else: nov_niz = nov_niz + i
    for i, v in enumerate(nov_niz):
        i = i + 1
        if i % 4 == 1:
            prva_vrsta += v
            druga_vrsta += '.'
        ...
        if i % 4 == 3:
            ...
            druga_vrsta += '.'
            tretja_vrsta += v
    return (prva_vrsta, druga_vrsta, tretja_vrsta)
...
def cik_cak_sifra(niz):
    v1, v2, v3 = cik_cak(niz)
    nov_niz = v1+v2+v3
    return nov_niz.replace('.','')
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDkyLCJ1c2VyIjoxMTUzOH0:1wCJ2q:G5Zdq_2lIP4157kZ88CG6ellAeMqgzO29NaALr9cshQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDkzLCJ1c2VyIjoxMTUzOH0:1wCJ2q:QD_Pi2ZNrP3Pg1FWSduK4R_T7lyVce6js56amLH1ibM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDk0LCJ1c2VyIjoxMTUzOH0:1wCJ2q:bvsQMD4nEpSXMcSJf1CKgEwPlY_yOBT79S3atMGVJtA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDk1LCJ1c2VyIjoxMTUzOH0:1wCJ2q:7keDItAHjx02g9MMp2gmKjjbQNsXS-YSEQUz1AadBXI"
        try:
