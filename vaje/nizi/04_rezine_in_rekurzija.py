...
#     "N__g__m_______m__"
# =============================================================================
def filtriraj(geslo, crke):
    if not geslo or not crke:
        return ''
    else:
        if geslo[0].lower() in crke.lower():
            return geslo[0] + filtriraj(geslo[1:], crke)
        else:
            return '_' + filtriraj(geslo[1:], crke)
# =====================================================================@027490=
# 2. podnaloga
...
# =============================================================================
import string
def pretvori(stevilo, baza):
    vrednosti = '0123456789' + string.ascii_uppercase
    if stevilo == '':
        return 0
    else:
        return vrednosti.index(stevilo[-1]) + pretvori(stevilo[:-1], baza)*baza
# =====================================================================@027489=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NiwidXNlciI6MTE1Mzh9:1vzdCS:PmVH92enRAVO08Lc9-yhqmEITWH2AbUAVlwC5R5GpEY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MCwidXNlciI6MTE1Mzh9:1vzdCS:ddMY_7cGI8A-uwYFIMXnUNuFvbR6zgKWn4MDFS0k2c8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4OSwidXNlciI6MTE1Mzh9:1vzdCS:l1tfGKaWzaHlYwp4AxhZEwNdih9VJzYYVIdt0ROSD3Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NywidXNlciI6MTE1Mzh9:1vzdCS:4iMWJwAgG0Ibf8WK2ly6fJcV9XVz8cVd7R_ffWnk_YE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4OCwidXNlciI6MTE1Mzh9:1vzdCS:F8WkI05uy1slNSlAMMVMANndaFYsq_jkuoHndKmidvA"
        try:
