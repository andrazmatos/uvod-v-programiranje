...
def pari(slovar):
    couples = set()
    for oseba in slovar:
        kandidati = slovar[oseba]
        for kandidat in kandidati:
            if oseba in slovar[kandidat]:
                if oseba < kandidat:
                    couples.add((oseba, kandidat))
                else:
                    couples.add((kandidat, oseba))
    return couples
# =====================================================================@001387=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg0LCJ1c2VyIjoxMTUzOH0:1w7EIL:tOVaKGMPvw2eXf6WsIOg9zyoCaEHj24AVrMIt1yCZxA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg1LCJ1c2VyIjoxMTUzOH0:1w7EIL:BcuJzHC76oqY8ZbGAykDTjV7Ltn5oJQWSG8zOFRO62U"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg2LCJ1c2VyIjoxMTUzOH0:1w7EIL:14_e5zlmqgBP4M8_e6GtfDdm6u_fJ94aPA8c2VnmjfQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg3LCJ1c2VyIjoxMTUzOH0:1w7EIL:EQzWSctuX572qY7_SdgDUO6KITh239Aj8sp-518h-R8"
        try:
