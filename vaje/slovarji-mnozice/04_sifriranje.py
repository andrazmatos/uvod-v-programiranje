...
#     'UOČVUOČBI'
# =============================================================================
def sifriraj(nasa_sifra, niz):
    sifra = ''
    for crka in niz:
        sifra += nasa_sifra[crka]
    return sifra

'''return ''.join(nasa_sifra[crka] for crka in niz)'''
# =====================================================================@001389=
# 2. podnaloga
...
def odsifriraj(sifra, niz):
    if not ali_je_sifra(sifra):
        ...
        return sifriraj(inverz(sifra), niz)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg4LCJ1c2VyIjoxMTUzOH0:1w7EIL:TzsoDi7QqJzfLbrn1J9cqAQLqrkx4IIhNe-nBWLGgeg"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg5LCJ1c2VyIjoxMTUzOH0:1w7EIL:YHGBtZSW4B9uHHzlUU53XR614hauLzc7S53lOvuwN4I"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkwLCJ1c2VyIjoxMTUzOH0:1w7EIL:ruOvQO3rvgdxdCGY1Ju4ZFuXv11TAlqkIeV6h-2Sf8Q"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkxLCJ1c2VyIjoxMTUzOH0:1w7EIL:HpCdPQKhgSehULxAXejPo5yYHdjZOFpbY-W5Ovj5dzI"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
