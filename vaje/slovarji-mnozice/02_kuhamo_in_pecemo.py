...
def pomnozi(recept, faktor):
    ...
    for sestavina in recept:
        nov_recept[sestavina] = recept[sestavina] * faktor
    return nov_recept
# =====================================================================@001393=
# 2. podnaloga
...
def kaj_moramo_se_kupiti(recept, shramba):
    ...
    for sestavina in recept:
        if sestavina not in shramba:
            nakupovalni_listek[sestavina] = recept[sestavina]
        elif recept[sestavina] > shramba[sestavina]:
            nakupovalni_listek[sestavina] = recept[sestavina] - shramba[sestavina]
    return nakupovalni_listek
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkyLCJ1c2VyIjoxMTUzOH0:1w7EIL:Sv6Wg24jp_7ldxecUznkOSStZ9ZfVVFSHtVt-yvlGSI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkzLCJ1c2VyIjoxMTUzOH0:1w7EIL:1aDp2iITp4Y2qBbCMHOkEAq1CieCGnfcsrGcQri56IE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzk0LCJ1c2VyIjoxMTUzOH0:1w7EIL:dOdMp649f4VRiRtkvWhNqjeHazY3qJxgZTnlj_GbKhM"
        try:
