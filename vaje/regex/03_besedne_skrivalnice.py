...
def malce_anonimiziraj(niz):
    vzorec = r'([A-ZČŠŽ][a-zčšž]+) ([A-ZČŠŽ])[a-zčšž]+'
    def zamenjaj(zadetek):
        return zadetek.group(1) + ' ' + zadetek.group(2) + '.'
    return re.sub(vzorec, zamenjaj, niz)
# =====================================================================@033406=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwNCwidXNlciI6MTE1Mzh9:1wOzpJ:neVuQSp6r6stHK9PsEv6dCj0Mt5wW8Q2QoXCrjiMBxs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwNiwidXNlciI6MTE1Mzh9:1wOzpJ:rHIFF0_JL8rc2-LdxzhE9LpXpScw3Jkmr1IqPobdxWc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwNSwidXNlciI6MTE1Mzh9:1wOzpJ:nHpNk6Acmy_jTj7tX8VcurRDRadCqxaLv2lGGcICeks"
        try:
