...
#     'Ananas'
# =============================================================================
def odstrani_veckratne_vprasaje(besedilo):
    return re.sub(r"\?+", "?", besedilo)
...
def enote_na_konec(niz):
    vzorec = r"([€$]) ?(\d+)"
    izhod = r"\2 \1"
    return re.sub(vzorec, izhod, niz)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDA5MywidXNlciI6MTE1Mzh9:1wOzpJ:yb0poRnzzRTmOcKSRDfI53Tew8iUZMc9jJXrV6rd4tU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMiwidXNlciI6MTE1Mzh9:1wOzpJ:vve99sUoT1CHBeX50dcvZ9qRylVrOFKf0OVilxLEG3w"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMywidXNlciI6MTE1Mzh9:1wOzpJ:uFVTJ79GKPyR3HJogz0W4jfOZXS58waxP1lsGnArc7U"
        try:
            Check.equal(
                'enote_na_konec("Cena kave je € 2, cena čaja pa €3.")',
                "Cena kave je 2 €, cena čaja pa 3 €."
