...
class Matrika:
    ...
    def __add__(self, other):
        nova = []
        for j_1, j_2 in zip(self.matrika, other.matrika):
            nova_vrstica = []
            for i_1, i_2 in zip(j_1, j_2):
                nova_vrstica.append(i_1 + i_2)
            nova.append(nova_vrstica)
        return Matrika(nova)
