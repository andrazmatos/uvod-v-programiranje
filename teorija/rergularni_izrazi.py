...
# d? - 0 ali 1 pojavitev d-ja
# [ñññ] - list , iz katerega nekaj mora imeti tisto, kar iščemo
# [^a] - brez a-ja
# [a-z] - pojdi od a do z
# [a-z]{4}: štiri črke
# (?P<id>\d) - 
...
def izlusci_naslove(vsebina):
    filmi = []
    for najdba in re.finditer(r'<a\s*https://www\.imdb\.com/tile/tt(?P<id>\d)+', vsebina, flags=re.DOTALL):
        filmi.append(najdba)
    print(len(filmi))
